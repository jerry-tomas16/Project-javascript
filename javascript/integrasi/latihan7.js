...
const showDetails = async (id) => {
  ...
  try {
    ...
    document.getElementById("detailsContent").innerHTML = `
                <div><strong>Name:</strong> ${data.id}</div>
                <div><strong>Email:</strong> ${data.user_id}</div>
                <div><strong>Gender:</strong> ${data.title}</div>
                <div><strong>Status:</strong> ${data.body}</div>
                `;
